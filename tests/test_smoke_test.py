...
class TestSmoke():
  ...
  def test_smoke(self):
    ...
    self.driver.set_window_size(1038, 700)
    ...
    self.driver.find_element(By.NAME, "biztitle").send_keys("Sales")
    ...
    assert element.is_enabled() is True
    self.driver.find_element(By.ID, "username").click()
    self.driver.find_element(By.ID, "username").send_keys("tnkomo@byupathway.edu")
    self.driver.find_element(By.ID, "password").click()
    self.driver.find_element(By.ID, "password").send_keys("tams3030")
